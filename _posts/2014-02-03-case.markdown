...
<!-- DEREK: These two practice problems were very hard when I first attempted them.  Not entirely sure what to do about it, but maybe more explaination is needed.  Maybe an example using both a CASE and a WHERE clause to show how that would divide up the problem
-->
...
<!-- DEREK: You mention histograms, then you don't really expand upon it.  You should either go into a bit more depth about it here or cover it later and do a "this is covered in a later lesson" link -->

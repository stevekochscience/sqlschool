...
The entire demo is meant to be completed using Mode, so you should <a href="http://modeanalytics.com" target="_blank">open up another browser window to Mode</a>. You'll retain the most information if you run the example queries and try to understand results, and complete the practice exercises.
